<p>You have successfully completed your fund transfer with the following details:</p>
<table style="border: 1px solid black;border-collapse: collapse; width:50%">
    ...
    <tr>
    <td style="border: 1px solid black;border-collapse: collapse;padding: 15px; font-weight: bold;">Transfer Amount    :</td>
